...
<body>
        ...
        <div class="cs-main_header_in">
          ...
          <div class="cs-main_header_right">
            <div class="cs-toolbox">
              ...
              <span class="cs-btn cs-color1 cs-modal_btn" data-modal="register"><span>Request Demo</span></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="cs-hero cs-style1 cs-bg" data-src="/assets/img/hero_bg.svg">
      <div class="container">
        ...
        <div class="cs-hero_text">
          <div class="cs-hero_secondary_title">Try Free for one Month.
          </div>
          <h1 class="cs-hero_title">Supercharge <br> Your Business</h1>
          <div class="cs-hero_subtitle">Take Control of Your Business On the Go with our Mobile-Compatible <br>POS Software Tailored for Nigerian Entrepreneurs.</div>
          <a href="#" class="cs-btn"><span>Request a Demo</span></a>
        </div>
        ...
        <div class="col-md-6 col-xl-3">
          ...
          <div class="cs-iconbox cs-style1">
            ...
            <div class="cs-iconbox_in">
              ...
              <h3 class="cs-iconbox_title">Inventory Management</h3>
              <div class="cs-iconbox_subtitle"> Effortlessly track your stock levels, set automated reorder points, and stay on top of your inventory to avoid stockouts.</div>
            </div>
          </div>
        ...
        <div class="col-md-6 col-xl-3">
          <div class="cs-iconbox cs-style1">
            ...
            <div class="cs-iconbox_in">
              ...
              <h3 class="cs-iconbox_title">User-Friendly Interface</h3>
              <div class="cs-iconbox_subtitle">Our intuitive interface requires minimal training, ensuring your staff can start using the software with ease.</div>
            </div>
          </div>
          <div class="cs-height_25 cs-height_lg_25"></div>
        </div>
        <div class="col-md-6 col-xl-3">
          ...
          <div class="cs-iconbox cs-style1">
            ...
            <div class="cs-iconbox_in">
              ...
              <h3 class="cs-iconbox_title">Sales and Reporting</h3>
              <div class="cs-iconbox_subtitle">Generate detailed reports, track sales performance, identify trends, and gain insights into your business's financial health.</div>
            </div>
          </div>
          <div class="cs-height_25 cs-height_lg_25"></div>
        </div>
        <div class="col-md-6 col-xl-3">
          <div class="cs-iconbox cs-style1">
            ...
            <div class="cs-iconbox_in">
              ...
              <h3 class="cs-iconbox_title">Customer Relationship Management</h3>
              <div class="cs-iconbox_subtitle">Build strong customer relationships with our CRM tools. Collect customer data, and run targeted marketing campaigns.</div>
            </div>
          </div>
          <div class="cs-height_25 cs-height_lg_25"></div>
        </div>
      ...
      <div class="row align-items-center flex-column-reverse-lg">
        ...
        <div class="col-xl-6">
          ...
          <div class="cs-seciton_heading cs-style1">
            ...
            <div class="cs-height_10 cs-height_lg_10"></div>
            <h3 class="cs-section_title">Welcome to StoreMate - Nigeria's Premier POS Solution! </h3>
          </div>
          <div class="cs-height_20 cs-height_lg_20"></div>
          <p>
            Empower your business with our cutting-edge, cloud-based POS software designed exclusively for Nigerian businesses. With our user-friendly interface and mobile compatibility, you can revolutionize the way you do business, all at an affordable monthly subscription fee.
          </p>
            ...
            <ul class="cs-list cs-style1 cs-mp0">
              <li>
                ...
                <div class="cs-list_right">
                  <h3>Streamlined for Nigerian Businesses</h3>
                  <p>Our POS software is designed to meet the unique requirements of Nigerian businesses. Simplify transactions, effortlessly manage inventory, and deliver exceptional customer service with our solution.</p>
                </div>
              </li>
              <li>
                <span class="cs-list_icon">
                ...
                <div class="cs-list_right">
                  <h3>Cloud-Based Convenience</h3>
                  <p>No more installations or software updates. Our cloud-based POS solution securely hosts your data and ensures access from anywhere. Sync information, manage inventory across multiple locations, and gain valuable insights for informed decision-making.</p>
                </div>
              </li>
              <li>
                <span class="cs-list_icon">
                ...
                <div class="cs-list_right">
                  ...
                  <p>Embrace the freedom of doing business on-the-go with our mobile-ready platform. Process transactions, access real-time data, and manage your business from your smartphone or tablet.</p>
                </div>
              </li>
            </ul>
    ...
    <div class="cs-funfact_1_wrap cs-type1">
      <div class="cs-funfact cs-style1">
        ...
        <div class="cs-funfact_right">
          <div class="cs-funfact_number cs-primary_font"><span data-count-to="246" class="odometer"></span>+</div>
      ...
      <div class="cs-funfact cs-style1">
        ...
        <div class="cs-funfact_right">
          <div class="cs-funfact_number cs-primary_font"><span data-count-to="52" class="odometer"></span>k</div>
          <h2 class="cs-funfact_title">Customers</h2>
        </div>
      </div>
      <div class="cs-funfact cs-style1">
      ...
      <div class="cs-funfact cs-style1">
        ...
        <div class="cs-funfact_right">
          <div class="cs-funfact_number cs-primary_font"><span data-count-to="4" class="odometer"></span>+</div>
    ...
    <div id="feature">
      ...
      <div class="container">
        <div class="cs-seciton_heading cs-style1 text-center">
          ...
          <div class="cs-height_10 cs-height_lg_10"></div>
          <h3 class="cs-section_title">features of StoreMate</h3>
        </div>
        <div class="cs-height_50 cs-height_lg_40"></div>
        <div class="row">
          <div class="col-xl-4 col-md-6">
            <div class="cs-iconbox cs-style1 cs-type1">
              ...
              <div class="cs-iconbox_in">
                <h3 class="cs-iconbox_title">Pilferage Prevention</h3>
                <div class="cs-iconbox_subtitle">Safeguard your business with security measures like user access controls, transaction tracking, and inventory audits to minimize losses.</div>
              </div>
            </div>
            <div class="cs-height_25 cs-height_lg_25"></div>
          </div>
          ...
          <div class="col-xl-4 col-md-6">
            <div class="cs-iconbox cs-style1 cs-type1">
              ...
              <div class="cs-iconbox_in">
                <h3 class="cs-iconbox_title">Sales and Order Management</h3>
                <div class="cs-iconbox_subtitle">Streamline sales processes, generate invoices, and manage returns for improved customer satisfaction.</div>
              </div>
            </div>
            <div class="cs-height_25 cs-height_lg_25"></div>
          </div>
          <div class="col-xl-4 col-md-6">
            <div class="cs-iconbox cs-style1 cs-type1">
              ...
              <div class="cs-iconbox_in">
                <h3 class="cs-iconbox_title">Reporting and Analytics</h3>
                <div class="cs-iconbox_subtitle">Gain valuable insights into sales, inventory, and financials to make data-driven business decisions.</div>
              </div>
            </div>
            <div class="cs-height_25 cs-height_lg_25"></div>
          </div>
          <div class="col-xl-4 col-md-6">
            <div class="cs-iconbox cs-style1 cs-type1">
              ...
              <div class="cs-iconbox_in">
                <h3 class="cs-iconbox_title">Integration Capabilities</h3>
                <div class="cs-iconbox_subtitle">Seamlessly connect with payment gateways, accounting software, and e-commerce platforms for streamlined operations.</div>
              </div>
            </div>
            <div class="cs-height_25 cs-height_lg_25"></div>
          </div>
          ...
          <div class="col-xl-4 col-md-6">
            <div class="cs-iconbox cs-style1 cs-type1">
              ...
              <div class="cs-iconbox_in">
                <h3 class="cs-iconbox_title">Credit Purchases</h3>
                <div class="cs-iconbox_subtitle">Cater to customers who prefer purchasing on credit, managing credit limits and terms efficiently for a seamless shopping experience.</div>
              </div>
            </div>
            <div class="cs-height_25 cs-height_lg_25"></div>
          </div>
          <div class="col-xl-4 col-md-6">
            <div class="cs-iconbox cs-style1 cs-type1">
              ...
              <div class="cs-iconbox_in">
                <h3 class="cs-iconbox_title">Reorder Management</h3>
                <div class="cs-iconbox_subtitle">Streamline inventory replenishment by setting automatic reorder points, receiving notifications, and maintaining optimal stock levels.</div>
              </div>
            </div>
            <div class="cs-height_25 cs-height_lg_25"></div>
          </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="cs-iconbox cs-style2 text-center">
                    ...
                    <h2 class="cs-iconbox_title">Wholesale Businesses</h2>
                  </div>
                  <div class="cs-height_25 cs-height_lg_25"></div>
                </div>
                <div class="col-md-6">
                  <div class="cs-iconbox cs-style2 text-center">
                    ...
                    <h2 class="cs-iconbox_title">Retail Stores</h2>
                  </div>
                  <div class="cs-height_25 cs-height_lg_25"></div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="cs-iconbox cs-style2 text-center">
                    ...
                    <h2 class="cs-iconbox_title">Restaurants</h2>
                  </div>
                  <div class="cs-height_25 cs-height_lg_25"></div>
                </div>
                <div class="col-md-6">
                  <div class="cs-iconbox cs-style2 text-center">
                    ...
                    <h2 class="cs-iconbox_title">Supermarkets</h2>
                  </div>
                  <div class="cs-height_25 cs-height_lg_25"></div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="cs-iconbox cs-style2 text-center">
                    ...
                    <h2 class="cs-iconbox_title">Fashion Store</h2>
                  </div>
                  <div class="cs-height_25 cs-height_lg_25"></div>
                </div>
                <div class="col-md-6">
                  <div class="cs-iconbox cs-style2 text-center">
                    ...
                    <h2 class="cs-iconbox_title">Pharmacies</h2>
                  </div>
                  <div class="cs-height_25 cs-height_lg_25"></div>
                </div>
              </div>
      ...
      <div class="row">
          ...
          <div class="cs-pricing_table cs-style1">
            <div class="cs-pricing_head">
              <div class="cs-pricing_heading">
                <div class="cs-pricing_icon cs-center"><img src="/assets/img/icons/pricing_icon_1.svg" alt="Icon"></div>
                <h2 class="cs-pricing_title cs-m0">Basic Plan</h2>
              </div>
              <div class="cs-price cs-primary_font">
                <b class="cs-accent_color">₦4,000</b>
                <span>/month</span>
              </div>
            ...
            <div class="cs-pricing_body">
              <ul class="cs-mp0 cs-pricing_feature">
                ...
                <li>
                  ...
                  <span>Sales and order management</span>
                </li>
                <li>
                  <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.18215 0C3.771 0 0.18219 3.58872 0.18219 7.99996C0.18219 12.4112 3.771 16 8.18215 16C12.5933 16 16.1821 12.4112 16.1821 7.99996C16.1821 3.58872 12.5934 0 8.18215 0ZM12.7759 6.6487L7.7499 11.6747C7.53619 11.8884 7.25212 12.006 6.94993 12.006C6.64774 12.006 6.36366 11.8884 6.14996 11.6747L3.58843 9.11314C3.37473 8.89944 3.25702 8.61536 3.25702 8.31317C3.25702 8.01089 3.37473 7.72682 3.58843 7.51311C3.80205 7.29941 4.08613 7.18171 4.3884 7.18171C4.69059 7.18171 4.97475 7.29941 5.18837 7.5132L6.94984 9.27459L11.1758 5.04867C11.3895 4.83497 11.6735 4.71735 11.9757 4.71735C12.2779 4.71735 12.562 4.83497 12.7757 5.04867C13.217 5.48994 13.217 6.2076 12.7759 6.6487Z" fill="#47C4C0"/>
        ...
        <div class="col-lg-4">
          <div class="cs-pricing_table cs-style1">
            <div class="cs-pricing_head">
              <div class="cs-pricing_heading">
                <div class="cs-pricing_icon cs-center"><img src="/assets/img/icons/pricing_icon_2.svg" alt="Icon"></div>
                <h2 class="cs-pricing_title cs-m0">Standard Plan</h2>
              </div>
              <div class="cs-price cs-primary_font">
                <b class="cs-accent_color">₦6,000</b>
                <span>/month</span>
              </div>
              <div class="cs-pricing_lable">Get 7 Days Free Trial</div>
            </div>
            <div class="cs-pricing_body">
              <ul class="cs-mp0 cs-pricing_feature">
                ...
                <li>
                  ...
                  <span>Salary advances for staff</span>
                </li>
                <li>
                  <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.18215 0C3.771 0 0.18219 3.58872 0.18219 7.99996C0.18219 12.4112 3.771 16 8.18215 16C12.5933 16 16.1821 12.4112 16.1821 7.99996C16.1821 3.58872 12.5934 0 8.18215 0ZM12.7759 6.6487L7.7499 11.6747C7.53619 11.8884 7.25212 12.006 6.94993 12.006C6.64774 12.006 6.36366 11.8884 6.14996 11.6747L3.58843 9.11314C3.37473 8.89944 3.25702 8.61536 3.25702 8.31317C3.25702 8.01089 3.37473 7.72682 3.58843 7.51311C3.80205 7.29941 4.08613 7.18171 4.3884 7.18171C4.69059 7.18171 4.97475 7.29941 5.18837 7.5132L6.94984 9.27459L11.1758 5.04867C11.3895 4.83497 11.6735 4.71735 11.9757 4.71735C12.2779 4.71735 12.562 4.83497 12.7757 5.04867C13.217 5.48994 13.217 6.2076 12.7759 6.6487Z" fill="#47C4C0"/>
                  </svg>                 
                  <span>Credit purchases management for customers</span>
                </li>
                <li>
                  <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.18215 0C3.771 0 0.18219 3.58872 0.18219 7.99996C0.18219 12.4112 3.771 16 8.18215 16C12.5933 16 16.1821 12.4112 16.1821 7.99996C16.1821 3.58872 12.5934 0 8.18215 0ZM12.7759 6.6487L7.7499 11.6747C7.53619 11.8884 7.25212 12.006 6.94993 12.006C6.64774 12.006 6.36366 11.8884 6.14996 11.6747L3.58843 9.11314C3.37473 8.89944 3.25702 8.61536 3.25702 8.31317C3.25702 8.01089 3.37473 7.72682 3.58843 7.51311C3.80205 7.29941 4.08613 7.18171 4.3884 7.18171C4.69059 7.18171 4.97475 7.29941 5.18837 7.5132L6.94984 9.27459L11.1758 5.04867C11.3895 4.83497 11.6735 4.71735 11.9757 4.71735C12.2779 4.71735 12.562 4.83497 12.7757 5.04867C13.217 5.48994 13.217 6.2076 12.7759 6.6487Z" fill="#47C4C0"/>
                  </svg>                   
                  <span>Reorder management system</span>
                </li>
                <li class="cs-inactive">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M7.99583 0C3.57967 0 0 3.58154 0 8C0 12.4185 3.57967 16 7.99583 16C12.412 16 15.9917 12.4185 15.9917 8C15.9917 3.58154 12.412 0 7.99583 0ZM6.58529 5.71897C6.52898 5.65851 6.46108 5.61002 6.38563 5.57639C6.31018 5.54275 6.22873 5.52466 6.14615 5.52321C6.06356 5.52175 5.98153 5.53695 5.90495 5.5679C5.82836 5.59885 5.75879 5.64492 5.70038 5.70335C5.64198 5.76179 5.59593 5.8314 5.565 5.90802C5.53407 5.98465 5.51887 6.06672 5.52033 6.14935C5.52179 6.23198 5.53986 6.31347 5.57348 6.38895C5.6071 6.46444 5.65557 6.53238 5.716 6.58872L7.12654 8L5.716 9.41128C5.65557 9.46762 5.6071 9.53556 5.57348 9.61105C5.53986 9.68653 5.52179 9.76802 5.52033 9.85065C5.51887 9.93328 5.53407 10.0154 5.565 10.092C5.59593 10.1686 5.64198 10.2382 5.70038 10.2966C5.75879 10.3551 5.82836 10.4012 5.90495 10.4321C5.98153 10.4631 6.06356 10.4783 6.14615 10.4768C6.22873 10.4753 6.31018 10.4572 6.38563 10.4236C6.46108 10.39 6.52898 10.3415 6.58529 10.281L7.99583 8.86974L9.40638 10.281C9.46269 10.3415 9.53059 10.39 9.60604 10.4236C9.68149 10.4572 9.76293 10.4753 9.84552 10.4768C9.92811 10.4783 10.0101 10.4631 10.0867 10.4321C10.1633 10.4012 10.2329 10.3551 10.2913 10.2966C10.3497 10.2382 10.3957 10.1686 10.4267 10.092C10.4576 10.0154 10.4728 9.93328 10.4713 9.85065C10.4699 9.76802 10.4518 9.68653 10.4182 9.61105C10.3846 9.53556 10.3361 9.46762 10.2757 9.41128L8.86513 8L10.2757 6.58872C10.3361 6.53238 10.3846 6.46444 10.4182 6.38895C10.4518 6.31347 10.4699 6.23198 10.4713 6.14935C10.4728 6.06672 10.4576 5.98465 10.4267 5.90802C10.3957 5.8314 10.3497 5.76179 10.2913 5.70335C10.2329 5.64492 10.1633 5.59885 10.0867 5.5679C10.0101 5.53695 9.92811 5.52175 9.84552 5.52321C9.76293 5.52466 9.68149 5.54275 9.60604 5.57639C9.53059 5.61002 9.46269 5.65851 9.40638 5.71897L7.99583 7.13026L6.58529 5.71897Z" fill="#47C4C0"/>
                  </svg>                    
                  <span>More than 2 Locations</span>
                </li>
                <li class="cs-inactive">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M7.99583 0C3.57967 0 0 3.58154 0 8C0 12.4185 3.57967 16 7.99583 16C12.412 16 15.9917 12.4185 15.9917 8C15.9917 3.58154 12.412 0 7.99583 0ZM6.58529 5.71897C6.52898 5.65851 6.46108 5.61002 6.38563 5.57639C6.31018 5.54275 6.22873 5.52466 6.14615 5.52321C6.06356 5.52175 5.98153 5.53695 5.90495 5.5679C5.82836 5.59885 5.75879 5.64492 5.70038 5.70335C5.64198 5.76179 5.59593 5.8314 5.565 5.90802C5.53407 5.98465 5.51887 6.06672 5.52033 6.14935C5.52179 6.23198 5.53986 6.31347 5.57348 6.38895C5.6071 6.46444 5.65557 6.53238 5.716 6.58872L7.12654 8L5.716 9.41128C5.65557 9.46762 5.6071 9.53556 5.57348 9.61105C5.53986 9.68653 5.52179 9.76802 5.52033 9.85065C5.51887 9.93328 5.53407 10.0154 5.565 10.092C5.59593 10.1686 5.64198 10.2382 5.70038 10.2966C5.75879 10.3551 5.82836 10.4012 5.90495 10.4321C5.98153 10.4631 6.06356 10.4783 6.14615 10.4768C6.22873 10.4753 6.31018 10.4572 6.38563 10.4236C6.46108 10.39 6.52898 10.3415 6.58529 10.281L7.99583 8.86974L9.40638 10.281C9.46269 10.3415 9.53059 10.39 9.60604 10.4236C9.68149 10.4572 9.76293 10.4753 9.84552 10.4768C9.92811 10.4783 10.0101 10.4631 10.0867 10.4321C10.1633 10.4012 10.2329 10.3551 10.2913 10.2966C10.3497 10.2382 10.3957 10.1686 10.4267 10.092C10.4576 10.0154 10.4728 9.93328 10.4713 9.85065C10.4699 9.76802 10.4518 9.68653 10.4182 9.61105C10.3846 9.53556 10.3361 9.46762 10.2757 9.41128L8.86513 8L10.2757 6.58872C10.3361 6.53238 10.3846 6.46444 10.4182 6.38895C10.4518 6.31347 10.4699 6.23198 10.4713 6.14935C10.4728 6.06672 10.4576 5.98465 10.4267 5.90802C10.3957 5.8314 10.3497 5.76179 10.2913 5.70335C10.2329 5.64492 10.1633 5.59885 10.0867 5.5679C10.0101 5.53695 9.92811 5.52175 9.84552 5.52321C9.76293 5.52466 9.68149 5.54275 9.60604 5.57639C9.53059 5.61002 9.46269 5.65851 9.40638 5.71897L7.99583 7.13026L6.58529 5.71897Z" fill="#47C4C0"/>
        ...
        <div class="col-lg-4">
          <div class="cs-pricing_table cs-style1">
            <div class="cs-pricing_head">
              <div class="cs-pricing_heading">
                <div class="cs-pricing_icon cs-center"><img src="/assets/img/icons/pricing_icon_3.svg" alt="Icon"></div>
                <h2 class="cs-pricing_title cs-m0">Premium Plan</h2>
              </div>
              <div class="cs-price cs-primary_font">
                <b class="cs-accent_color">₦17,000</b>
                <span>/month</span>
              </div>
              <div class="cs-pricing_lable">Get 7 Days Free Trial</div>
            </div>
            <div class="cs-pricing_body">
              <ul class="cs-mp0 cs-pricing_feature">
                <li>
                  ...
                  <span>All features from the Standard Plan</span>
                </li>
                <li>
                  <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.18215 0C3.771 0 0.18219 3.58872 0.18219 7.99996C0.18219 12.4112 3.771 16 8.18215 16C12.5933 16 16.1821 12.4112 16.1821 7.99996C16.1821 3.58872 12.5934 0 8.18215 0ZM12.7759 6.6487L7.7499 11.6747C7.53619 11.8884 7.25212 12.006 6.94993 12.006C6.64774 12.006 6.36366 11.8884 6.14996 11.6747L3.58843 9.11314C3.37473 8.89944 3.25702 8.61536 3.25702 8.31317C3.25702 8.01089 3.37473 7.72682 3.58843 7.51311C3.80205 7.29941 4.08613 7.18171 4.3884 7.18171C4.69059 7.18171 4.97475 7.29941 5.18837 7.5132L6.94984 9.27459L11.1758 5.04867C11.3895 4.83497 11.6735 4.71735 11.9757 4.71735C12.2779 4.71735 12.562 4.83497 12.7757 5.04867C13.217 5.48994 13.217 6.2076 12.7759 6.6487Z" fill="#47C4C0"/>
                  </svg>
                  <span>Advance Pilferage prevention mechanisms</span>
                </li>
                <li>
                  <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.18215 0C3.771 0 0.18219 3.58872 0.18219 7.99996C0.18219 12.4112 3.771 16 8.18215 16C12.5933 16 16.1821 12.4112 16.1821 7.99996C16.1821 3.58872 12.5934 0 8.18215 0ZM12.7759 6.6487L7.7499 11.6747C7.53619 11.8884 7.25212 12.006 6.94993 12.006C6.64774 12.006 6.36366 11.8884 6.14996 11.6747L3.58843 9.11314C3.37473 8.89944 3.25702 8.61536 3.25702 8.31317C3.25702 8.01089 3.37473 7.72682 3.58843 7.51311C3.80205 7.29941 4.08613 7.18171 4.3884 7.18171C4.69059 7.18171 4.97475 7.29941 5.18837 7.5132L6.94984 9.27459L11.1758 5.04867C11.3895 4.83497 11.6735 4.71735 11.9757 4.71735C12.2779 4.71735 12.562 4.83497 12.7757 5.04867C13.217 5.48994 13.217 6.2076 12.7759 6.6487Z" fill="#47C4C0"/>
                ...
                <li>
                  ...
                  <span>Customizable features and branding options</span>
                </li>
                <li>
                  <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.18215 0C3.771 0 0.18219 3.58872 0.18219 7.99996C0.18219 12.4112 3.771 16 8.18215 16C12.5933 16 16.1821 12.4112 16.1821 7.99996C16.1821 3.58872 12.5934 0 8.18215 0ZM12.7759 6.6487L7.7499 11.6747C7.53619 11.8884 7.25212 12.006 6.94993 12.006C6.64774 12.006 6.36366 11.8884 6.14996 11.6747L3.58843 9.11314C3.37473 8.89944 3.25702 8.61536 3.25702 8.31317C3.25702 8.01089 3.37473 7.72682 3.58843 7.51311C3.80205 7.29941 4.08613 7.18171 4.3884 7.18171C4.69059 7.18171 4.97475 7.29941 5.18837 7.5132L6.94984 9.27459L11.1758 5.04867C11.3895 4.83497 11.6735 4.71735 11.9757 4.71735C12.2779 4.71735 12.562 4.83497 12.7757 5.04867C13.217 5.48994 13.217 6.2076 12.7759 6.6487Z" fill="#47C4C0"/>
          ...
          <div class="cs-slider_wrapper">
            ...
            <div class="cs-slide">
              <div class="cs-testimonial cs-style1">
                <div class="cs-testimonial_text">"ShopSmart has experienced remarkable improvements in sales and inventory management since using your POS software. It's intuitive, streamlined, and has eliminated manual errors. Thanks to your software, I can focus on growing my business and providing excellent service."</div>
            ...
            <div class="cs-slide">
              <div class="cs-testimonial cs-style1">
                <div class="cs-testimonial_text">"TasteBuds Restaurant has become more efficient and customer-friendly with your POS software. Orders are processed faster, reducing wait times. The detailed analytics have helped us optimize our menu. Your software has had a positive impact on our business."</div>
                <div class="cs-testimonial_meta">
                  <div class="cs-avatar">
                    <img src="/assets/img/avatar_1.png" alt="Avatar">
                    <div class="cs-quote cs-center">
                  ...
                  <div class="cs-testimonial_meta_right">
                    <h3>Emeka Nwosu</h3>
                    <p>Manager at TasteBuds Restaurant</p>
                    <div class="cs-review" data-review="4">
                      <img src="/assets/img/icons/stars.svg" alt="Star">
                      <div class="cs-review_in">
                        <img src="/assets/img/icons/stars.svg" alt="Star">
            ...
            <div class="cs-slide">
              <div class="cs-testimonial cs-style1">
                <div class="cs-testimonial_text">"MegaMart Supermarket's inventory control has significantly improved with your POS software. Stock tracking and reorder management are now effortless, minimizing wastage. Your software has contributed to the success and growth of our supermarket."</div>
                <div class="cs-testimonial_meta">
                  <div class="cs-avatar">
                    <img src="/assets/img/avatar_1.png" alt="Avatar">
                    <div class="cs-quote cs-center">
                  ...
                  <div class="cs-testimonial_meta_right">
                    <h3>Funke Adekunle</h3>
                    <p>Owner of MegaMart Supermarket</p>
                    <div class="cs-review" data-review="4">
                      <img src="/assets/img/icons/stars.svg" alt="Star">
                      <div class="cs-review_in">
                        <img src="/assets/img/icons/stars.svg" alt="Star">
            ...
            <div class="cs-slide">
              <div class="cs-testimonial cs-style1">
                <div class="cs-testimonial_text">"StyleHub Boutique's operations have become much easier with your POS software. The user-friendly interface and customer management features have allowed us to provide personalized experiences. Your software has enhanced our boutique's reputation and customer satisfaction."</div>
                <div class="cs-testimonial_meta">
                  <div class="cs-avatar">
                    <img src="/assets/img/avatar_1.png" alt="Avatar">
                    <div class="cs-quote cs-center">
                  ...
                  <div class="cs-testimonial_meta_right">
                    <h3>Samira Aliyu Umar</h3>
                    <p>Owner of StyleHub Boutique</p>
                    <div class="cs-review" data-review="4">
                      <img src="/assets/img/icons/stars.svg" alt="Star">
                      <div class="cs-review_in">
                        <img src="/assets/img/icons/stars.svg" alt="Star">
            ...
            <div class="cs-slide">
              <div class="cs-testimonial cs-style1">
                <div class="cs-testimonial_text">"As a wholesale business, we needed a robust POS software that could handle large volumes of transactions and track inventory accurately. Your POS software has exceeded our expectations. It seamlessly manages our wholesale orders, generates invoices, and tracks stock levels, allowing us to streamline our operations and serve our customers more efficiently. It has become an essential tool for our wholesale business."</div>
                <div class="cs-testimonial_meta">
                  <div class="cs-avatar">
                    <img src="/assets/img/avatar_1.png" alt="Avatar">
                    <div class="cs-quote cs-center">
            ...
            <div class="cs-slide">
              <div class="cs-testimonial cs-style1">
                <div class="cs-testimonial_text">"Running a hardware store comes with its unique challenges, but your POS software has made it much easier for us. The system's inventory tracking and management features have helped us stay on top of our extensive product range. The ability to quickly check stock availability and generate accurate invoices has improved our customer service. We appreciate the user-friendly interface and reliability of your software."</div>
                <div class="cs-testimonial_meta">
                  <div class="cs-avatar">
                    <img src="/assets/img/avatar_1.png" alt="Avatar">
                    <div class="cs-quote cs-center">
                  ...
                  <div class="cs-testimonial_meta_right">
                    <h3>Chioma Nwaso</h3>
                    <p>Owner of Handy Hardware Store</p>
                    <div class="cs-review" data-review="4">
                      <img src="/assets/img/icons/stars.svg" alt="Star">
                      <div class="cs-review_in">
                        <img src="/assets/img/icons/stars.svg" alt="Star">
          ...
          <div class="cs-accordians cs-style1 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
            <div class="cs-accordian cs-white_bg active">
              ...
              <div class="cs-accordian-body">
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard sincethe 15000s, printer took a galley of type and scrambl.
              </div>
            </div><!-- .cs-accordian -->
            <div class="cs-height_25 cs-height_lg_25"></div>
  ...
  <!-- End Post Section -->
  <section class="cs-bg" data-src="/assets/img/feature_bg.svg" id="news">
    <div class="cs-height_95 cs-height_lg_70"></div>
    <div class="container">
      <div class="cs-seciton_heading cs-style1 text-center">
          ...
          <div class="cs-slider_wrapper">
            <div class="cs-slide">
              <div class="cs-post cs-style1">
                <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="/assets/img/post_1.jpeg"></div></div>
            ...
            <div class="cs-slide">
              <div class="cs-post cs-style1">
                <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="/assets/img/post_2.jpeg"></div></div>
                <div class="cs-post_info">
                  <ul class="cs-post_meta cs-mp0">
                    <li>
                      <span class="cs-medium">
            ...
            <div class="cs-slide">
              <div class="cs-post cs-style1">
                <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="/assets/img/post_3.jpeg"></div></div>
                <div class="cs-post_info">
                  <ul class="cs-post_meta cs-mp0">
                    <li>
                      <span class="cs-medium">
            ...
            <div class="cs-slide">
              <div class="cs-post cs-style1">
                <div class="cs-post_thumb cs-modal_btn" data-modal="details"><div class="cs-post_thumb_in cs-bg" data-src="/assets/img/post_4.jpeg"></div></div>
                <div class="cs-post_info">
                  <ul class="cs-post_meta cs-mp0">
                    <li>
                      <span class="cs-medium">
